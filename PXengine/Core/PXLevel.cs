...
namespace PXengine.Core
{
    ...
    public abstract class PXLevel: IScript
    {
        ...
        protected virtual void InitLevel()
        {
            ...
            GameFactory.Instance.BuildScreen.Zoom = this.DEFAULT_SCALE;

            // inits based on level
            GameFactory.Instance.BuildScreen.BackgroundColor = this.BackgroundColor;
        ...
        protected virtual void InitPixie()
        {
            ...
            Pixie.C<PositionComp>().Position = TTUtil.Vec3(PIXIE_STARTING_POS);
            Pixie.C<TargetMotionComp>().Target = TTUtil.Vec3(PIXIE_STARTING_POS);
            Pixie.C<TargetMotionComp>().TargetVelocity = PIXIE_TARGETSPEED;
            Pixie.C<ControlComp>().TimeBetweenMoves = (1 / PIXIE_SPEED);
        }
        ...
        protected virtual void LevelKeyControl(ScriptComp ctx)
        {
