...
namespace TTengineTest
{
    ...
    class TestContentLoad : Test
    {
        public override void Create()
        {
            ...
            var b1 = Factory.CreateMovingBall(Factory.New(), new Vector2(400f, 300f), new Vector2(-8f,0f), 1,0.11f);

            Factory.BallSprite = "red-circle_frank-tschakert_runtime-load.png";
            var b2 = Factory.CreateMovingBall(Factory.New(), new Vector2(600f, 300f), new Vector2(8f,0f),1,0.1f);

            var p = new Vector2(0f, 100f);
            var t = Factory.CreateTextlet(Factory.New(), p, "XNA Content pipeline", Color.Black,0.11f);
            t.C<ScaleComp>().Scale = 0.5f;
            b1.C<PositionComp>().AddChild(t.C<PositionComp>());

            var t2 = Factory.CreateTextlet(Factory.New(), p, "Runtime loaded PNG", Color.Black,0.1f);
