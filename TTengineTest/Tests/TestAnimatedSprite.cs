...
namespace TTengineTest
{
    ...
    class TestAnimatedSprite : Test
    {
        public override void Create()
        {
            ...
            var s1 = Factory.CreateAnimatedSpritelet("SmileyWalk",4,4,AnimationType.NORMAL);
            s1.C<PositionComp>().Position = new Vector2(200f, 300f);
            s1.C<AnimatedSpriteComp>().SlowdownFactor = 2;

            var s2 = Factory.CreateAnimatedSpritelet("SmileyWalk", 4, 4, AnimationType.REVERSE);
            s2.C<PositionComp>().Position = new Vector2(400f, 300f);
            s2.C<AnimatedSpriteComp>().SlowdownFactor = 3;

            var s3 = Factory.CreateAnimatedSpritelet("SmileyWalk", 4, 4, AnimationType.NORMAL);
            ...
            var s4 = Factory.CreateAnimatedSpritelet("SmileyWalk", 4, 4, AnimationType.PINGPONG);
            ...
            var s5 = Factory.CreateAnimatedSpritelet("SmileyWalk", 4, 4, AnimationType.NORMAL);
